...
| `04-interview-questions.md` | 32+ interview questions grouped by Easy/Medium/Hard, with model answers focused on trade-offs. |
...
- **Defaults and limits.** Memorize the handful of numbers that drive design
  ...
  S3 single PUT 5 GB / multipart 5 TB; EBS gp3 baseline 3000 IOPS; RDS
  Multi-AZ standby is in a different AZ with synchronous replication). Numbers
  drift over releases — verify against current AWS documentation.
...
> Conventions: service behavior described reflects AWS as of 2025–2026. Always
