...
| `01-star-method-and-questions.md` | STAR in depth, story-bank construction, Amazon Leadership Principles, 20+ common questions with skeletal bullet-point answers, and incident/on-call story framing using a blameless-postmortem shape. |