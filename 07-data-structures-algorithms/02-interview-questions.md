...
### Q23: Serialize and Deserialize a Trie of Dictionary Words — import/export a routing/ictionary trie
...
### Q24: Palindrome Pairs — for which pair `(i,j)` is `words[i] + words[j]` a palindrome
...
### Q25: Median of Two Sorted Arrays — median of combined sorted arrays in O(log(min(n,m)))
...
3. Longest Substring Without Repeating Characters, Number of Islands, Rotting Oranges, Maximum Subarray — high-frequency patterns (sliding window, BFS, Kadane).
