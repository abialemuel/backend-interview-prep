...
Any access that triggers a query when the relation was not eager-loaded throws `LazyLoadingViolationException`. This is the single most effective N+1 detector; combine with Telescope/Debugbar for visibility.
